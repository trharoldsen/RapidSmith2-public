...
//	}
//
//	private static TileNodeTemplate makeTileWire(int i) {
//		String wireName = "dummy_wire_" + i;
//		return new TileNodeTemplate(i, new HashMap<>(), new ArraySet<>(), new ArraySet<>(), new ArraySet<>(), new ArraySet<>());
//	}
//
...
//
//		SiteTemplate siteTemplate = device.getTemplateOfSiteType(dummySiteType);
